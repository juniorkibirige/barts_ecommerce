...
<body style="background-color: cadetblue;">
    ...
    <div class="container">
      <div class="row justify-content-md-center text-center">
        <div class="mbr-white col-md-10">
          <img src="/images/android-chrome-512x512.png" alt="Giant Herbal Remedies" style="height: 200px;">
          <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-2">
            About Giant Herbal Remedies
          </h1>
  ...
  <section id="features1-1" class="text-center features1 cid-qyvcAqZyNq">
    <div class="container">
      <div class="media-container-row row">
        <div class="card p-3 col-12 col-md-6 col-lg-4">
          <div class="card-img pb-3 text-center">
            <span class="mbr-iconfont mbri-users bi bi-ticket-detailed" style="color: rgb(0, 0, 0);" media-simple="true"></span>
          </div>
          <div class="card-box">
            <h4 class="card-title py-3 mbr-fonts-style display-5">Our Mission</h4>
            <p class="mbr-text mbr-fonts-style display-7">
              Our mission is to build a legacy of health and wellness.
              As we grow, commitment to our mission remains at the core
              of our identity. It is woven into the decisions we make for the long-term health of our community and environment.
            </p>
          </div>
        </div>
        <div class="card p-3 col-12 col-md-6 col-lg-4">
          <div class="card-img pb-3 text-center">
            <span class="mbr-iconfont mbri-users bi bi-binoculars-fill" style="color: rgb(0, 0, 0);" media-simple="true"></span>
          </div>
          <div class="card-box">
            <h4 class="card-title py-3 mbr-fonts-style display-5">Our Vision</h4>
            <p class="mbr-text mbr-fonts-style display-7">
              Our vision is to offer the best Herbal people’s choice built on a solid foundation, for improving people’s health and lives.
            </p>
          </div>
        </div>
        <div class="card p-3 col-12 col-md-6 col-lg-4">
          <div class="card-img pb-3 text-center">
            <span class="mbr-iconfont mbri-users bi bi-card-checklist" style="color: rgb(0, 0, 0);" media-simple="true"></span>
          </div>
          <div class="card-box">
            <h4 class="card-title py-3 mbr-fonts-style display-5">Objectives</h4>
            <p class="mbr-text mbr-fonts-style display-7">
            <ol>
              <li>To provide the freshest, and pure natural health supplements.</li>
              <li>To provide effective and genuine herbal treatment to improve people’s lives.</li>
              <li>To promote good nutrition and dietary supplements for a healthy living.</li>
            </ol>
            </p>
          </div>
        </div>
  ...
  <section id="testimonials-slider1-3" class="carousel slide testimonials-slider cid-qyvf5AQs7c">
    <div class="container text-center">
      <?php
      $data_string = file_get_contents('./../testimonials.json');
